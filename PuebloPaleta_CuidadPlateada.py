...
def grafo():
    ...
    nodesP = ["Pueblo Paleta","Ciudad Verde","Bosque Verde","Cueva Diglet","Ciudad Plateada"]
    ...
    print("Ruta mas corta usando el algoritmo de Dijkstra entre Pueblo Paleta y Ciudad Plateada:",AD1)
    g=kanto.subgraph(AD1)
    ...
    plt.show()
    fig.savefig("PuebloPaleta_CuidadPlateada.png")
