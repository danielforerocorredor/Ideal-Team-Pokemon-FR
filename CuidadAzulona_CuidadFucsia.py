...
def grafo():
    ...
    kanto.add_edge("Ciudad Azulona","Ciudad Fucsia",weight=6)
    ...
    print("Ruta mas corta usando el algoritmo de Dijkstra entre Ciudad Azulona y Ciudad Fucsia: ",AD5)

    g=kanto.subgraph(AD5)
    ...
    plt.show()
    fig.savefig("CuidadAzulona_CuidadFucsia.png")
