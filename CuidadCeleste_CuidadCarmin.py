...
def grafo():
    ...
    #4kanto.add_edge("Monte Luna","Ciudad Celeste",weight=4)
    ...
    print("Ruta mas corta usando el algoritmo de Dijkstra entre Ciudad Celeste y Ciudad Carmin: ",AD3)
    g=kanto.subgraph(AD3)
    ...
    plt.show()
    fig.savefig("CuidadCeleste_CuidadCarmin.png")
