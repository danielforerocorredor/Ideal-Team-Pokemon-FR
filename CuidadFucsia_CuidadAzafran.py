...
def grafo():
    ...
    kanto.add_edge("Ciudad Azafran","Ciudad Azulona",weight=4)
    ...
    kanto.add_edge("Ciudad Carmin","Ciudad Azafran",weight=1)
    ...
    print("Ruta mas corta usando el algoritmo de Dijkstra entre Ciudad Fucsia y Ciudad Azafran: ",AD6)
    g=kanto.subgraph(AD6)
    ...
    plt.show()
    fig.savefig("CuidadFucsia_CuidadAzafran.png")
