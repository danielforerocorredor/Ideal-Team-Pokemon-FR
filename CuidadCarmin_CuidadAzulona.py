...
def grafo():
    ...
    print("Ruta mas corta usando el algoritmo de Dijkstra entre Ciudad Carmin y Ciudad Azulona: ",AD4)

    g=kanto.subgraph(AD4)
    ...
    plt.show()
    fig.savefig("CuidadCarmin_CuidadAzulona.png")
