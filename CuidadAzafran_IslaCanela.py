...
def grafo():
    ...
    nodesP = ["Isla Canela","Islas Espuma","Ciudad Azafran","Ciudad Carmin","Ciudad Fucsia"]
    nodesGym=["Isla Canela","Ciudad Carmin","Ciudad Fucsia","Ciudad Azafran"]
    nodees=["Islas Espuma"]
    color=['#CCFF99']
    ...
    print("Ruta mas corta usando el algoritmo de Dijkstra entre Ciudad Azafran y Isla Canela: ",AD7)
    g=kanto.subgraph(AD7)
    ...
    plt.show()
    fig.savefig("CuidadAzafran_IslaCanela.png")
